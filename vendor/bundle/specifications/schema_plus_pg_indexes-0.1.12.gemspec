# -*- encoding: utf-8 -*-
# stub: schema_plus_pg_indexes 0.1.12 ruby lib

Gem::Specification.new do |s|
  s.name = "schema_plus_pg_indexes"
  s.version = "0.1.12"
  ...
  s.homepage = "https://github.com/SchemaPlus/schema_plus_pg_indexes"
  s.licenses = ["MIT"]
  s.rubygems_version = "2.5.1"
  s.summary = "Adds support in ActiveRecord for PostgreSQL index expressions and operator classes, as well as a shorthand for case-insensitive indexes"

# -*- encoding: utf-8 -*-
# stub: schema_plus_indexes 0.2.4 ruby lib

Gem::Specification.new do |s|
  s.name = "schema_plus_indexes"
  s.version = "0.2.4"
  ...
  s.homepage = "https://github.com/SchemaPlus/schema_plus_indexes"
  s.licenses = ["MIT"]
  s.rubygems_version = "2.5.1"
  s.summary = "Adds shorthands and conveniences to ActiveRecord's handling of indexes"

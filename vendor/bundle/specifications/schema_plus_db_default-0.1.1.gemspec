# -*- encoding: utf-8 -*-
# stub: schema_plus_db_default 0.1.1 ruby lib

Gem::Specification.new do |s|
  s.name = "schema_plus_db_default"
  s.version = "0.1.1"
  ...
  s.date = "2016-03-24"
  s.description = "Defines constant ActiveRecord::DB_DEFAULT which, when saved as an attribute's value, causes the db to set the column to its default value."
  s.email = ["ronen@barzel.org"]
  s.homepage = "https://github.com/SchemaPlus/schema_plus_db_default"
  s.licenses = ["MIT"]
  s.rubygems_version = "2.5.1"
  s.summary = "Lets you set an ActiveRecord attribute to the db column's default value"
